...
export const RESUME_DATA = {
  ...
  work: [
    {
      company: "IE University School of Science and Technology",
      ...
      description: [
        ...
        "Leading development of an AI-driven computer vision system for remote access and automation of robots in the lab using OpenCV and Tensorflow.",
        "Developing distributed blockchain and smart contract based system using Solidity and Hardhat to allow secure and private interaction with robots and amenities available in the lab.",
      ],
      stack: "TensorFlow, PyTorch, OpenCV, Raspberry Pi, Solidity, Hardhat, Python",
    },
    {
